...
public class TResvableprepaymentTolAction extends BaseAction{
   ...
   private TResvableprepaymentDtlService tResvableprepaymentDtlService;
	...
	public void toList() throws Exception{
		...
		List<TResvableprepaymentTol> entList=(List<TResvableprepaymentTol>)tResvableprepaymentTolService.getByPage(start, endIndex,filterString, sortString.toString());
		int total = tResvableprepaymentTolService.getPageRowCount(filterString.toString());
	...
	public void toDown() throws Exception{
		...
		if(total<=65534 && total>0){
			List<?> list=tResvableprepaymentTolService.getByPage(Integer.parseInt(start), -1,filterString, sortString.toString());
	...
	public void toAdd() throws Exception{
		TResvableprepaymentTol obj = new TResvableprepaymentTol();
		...
		TResvableprepaymentTol oldObj=tResvableprepaymentTolService.getTResvableprepaymentTol(oblkeyId);
		...
		int result=tResvableprepaymentTolService.addTResvableprepaymentTol(obj);
		if(result>0){
	...
	public void toDel() throws Exception{
		...
		int result=tResvableprepaymentTolService.delTResvableprepaymentTol(id);
		if(result>0){
	...
	public void toEnt() throws Exception{
		String id = this.getStringParameter("id");
		TResvableprepaymentTol ent = tResvableprepaymentTolService.getTResvableprepaymentTol(id);
