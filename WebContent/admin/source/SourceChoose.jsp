...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/lib/source.filter.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/lib/timeout.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/admin/source/sourcechoose.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitSourceChoose);
</script>
</body>
</html>