...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/lib/icon.json.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/admin/source/sourceedit.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript">	
	    Ext.onReady(InitSourceEdit);
</script>
</body>
</html>