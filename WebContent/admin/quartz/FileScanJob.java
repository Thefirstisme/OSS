...
/**
 * Inspects a file and compares whether it's "last modified date" has changed since the last time it was inspected. If the file has been updated, the
 * job invokes a "call-back" method on an identified <code>FileScanListener</code> that can be found in the <code>SchedulerContext</code>.
 * 
 * @author jhouse
 * @author pl47ypus
...
public class FileScanJob implements StatefulJob {
    ...
    protected long getLastModifiedDate(String fileName) {
        ...
        furl = (furl != null) ? furl : testFile.getAbsolutePath();
        log.debug("Correct quartz_jobs.xml file path:" + furl);
        // === correct file path===
