...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/admin/log/log_sqlerror_list.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitLogSqlErrorList);
</script>
</body>
</html>