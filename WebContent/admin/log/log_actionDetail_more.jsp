...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/admin/log/log_actionDetail_more.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitActionDetailMore);
</script>
</body>
</html>