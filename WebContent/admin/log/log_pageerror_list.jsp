...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/admin/log/log_pageerror_list.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitLogPageErrorList);
</script>
</body>
</html>