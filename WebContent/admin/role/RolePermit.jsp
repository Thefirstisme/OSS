...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/admin/role/rolepermit.js"></script>
<script type="text/javascript">	
	    Ext.onReady(InitRoleSourcePermitRel);
</script>
</body>
</html>