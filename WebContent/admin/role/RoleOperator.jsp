...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/admin/role/roleoperator.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript">	
	    Ext.onReady(InitRoleOperatorRel);
</script>
</body>
</html>