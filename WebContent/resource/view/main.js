            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            region: 'center',
                            border: false,
                            html: '<div class=\'TopCenterCls\'>上海银行上海自贸区人行信息报送系统</div>',
                            id: 'panelTopCenter',
                            bodyStyle: 'background-color: #DFE8F6;',
                            title: ''
                        },
                            ...
                            items: [
                                {
                                    ...
                                    border: false,
                                    height: 20,
                                    html: '上午好，bos! 今天是：2013-06-26 星期三  09:53:22',
                                              ...
                                              listeners: {  
                                                  keyup: {
                                                    ...
                                                    if (Ext.EventObject.ESC == e.getKey()) {  
	                                                    	...
	                                                    	currTreePanel.filterByText(this.getRawValue());
	                                                    }  
                                                  	} 
                                                  }
                                              }
                    ...
                    items: [
                        {
                            ...
                            title: '我的工作平台',
                            iconCls: 'icon-house',
                            html : '<iframe style="height: 100%; width: 100%; border: none;" frameborder="0" src="itemPortal.jsp"></iframe>'
//                            items: {
//	   			                 xtype: 'component',
//	   			                 autoEl: {
//	   			                     tag: 'iframe',
...
//	   			                     },
//	   			                     render: function () {
//	   			                         this.up('panel').body.mask('正在装入：【我的工作平台】 模块，请稍候... ...');
//	   			                     }
//	   			                 }
//	   			             }
                        }
    ...
    onBtnCollapseAllClick: function(button, e, eOpts) {
    	currTreePanel.collapseAll();
    },
    onBtnExpandAllClick: function(button, e, eOpts) {
    	currTreePanel.expandAll();
    },
    onbtnThemeClick: function(button, e, eOpts) {
    	winOpen('主题设置',620,445,'icon-themeIcon','admin/syspara/ThemeSetting.jsp');
    },
    //修改密码
    ...
    ,onViewportAfterRender: function(component, eOpts) {
    	...
    	Ext.Ajax.request({ 
    		url: OSS.getAppName+"/admin/user/user_getUserMenuRoot",
    		//url: OSS.getAppName+"/rpt/rptTCorpdepoTol_getUserMenuRoot",
    		method : 'post', 
    		//params : {id: id},
    			...
    			Ext.getBody().unmask();  
    			 ...
    			 if(data)
    			 {
    				 for (var i = 0; i < data.length; i++) {  
    					 var itemStore=treepanelStore(data[i].sourceId);//eval('permitData_'+data[i].sourceId);//
//    					 tree.add(Ext.create("Ext.Panel",{
...
//    					 }));
    					 ...
    					 var treePanelId='treeMenuPanel_'+data[i].sourceId;
    					 var treePanel=Ext.create("widget.osstreepanel", {
 				    		id: treePanelId,  
						    title : data[i].sourceName,  
				            iconCls : data[i].iconCss,  
				            useArrows: true,  
...
var loadPage = function(rec) {
	...
	if (tabPanel.items.length > 10) {
		OSS.AlertInfo("您最多可以打开十个窗口，请关闭其它不用的窗口！");
		return;
	}
...
var treepanelStore = function(id) { // 创建树面板数据源  
    ...
    return Ext.create("Ext.data.TreeStore", {  
                ...
                proxy : {  
                    type : "ajax", // 获取方式  
                    url : OSS.getAppName+"/admin/user/user_getUserMenuItem" // 获取树节点的地址  
                },  
                clearOnLoad : true,  
...
var InitMain=function(){
	...
	new OSS.view.SysMain();
	setUserTimeInfo();
};
var setUserTimeInfo=function(){
//	Ext.Ajax.request({ 
//		url: OSS.getAppName+'/admin/user/user_getCurrentUserName',
//		method : 'get', 
//		success : function(response, options){ 
