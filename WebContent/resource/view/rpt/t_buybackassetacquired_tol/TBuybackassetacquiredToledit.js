...
//											regexText : '只能输入字母和数字'
	...
	onWindowShow : function(component, eOpts) {
		initWin = this;
		setTimeout(function() {
					getTBuybackassetacquiredTolInfo();
				}, 100);
	},
...
var initWin;
function getTBuybackassetacquiredTolInfo() {
	...
	if (keyid != "0") {
		...
		Ext.Ajax.request({
					url : OSS.getAppName
							+ '/rpt/rptTBuybackassetacquiredTol_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
					url : OSS.getAppName + "/rpt/rptTBuybackassetacquiredTol_"
							+ actionId,
					method : 'post',
					params : params,
