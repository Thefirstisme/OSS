Ext.define('OSS.view.TBuybackassetacquiredTolList', {
			...
			items : [{
				...
				items : [{
							...
							columns : [{
										...
										xtype : 'gridcolumn',
										text: '对方客户性质',
										renderer: getOppositeCustAttriRender,
										dataIndex : 'oppositeCustAttri'
									}, {
										xtype : 'gridcolumn',
										text : '对方账号',
										...
										dataIndex : 'buyAssetType' 
									}, {
										xtype : 'gridcolumn',
										text : '原资产总价值',
										dataIndex : 'origAssetTotalVal'
									}, {
										xtype : 'gridcolumn',
										text: '原期限单位',
										renderer: getPeriodUnitRender,
										dataIndex : 'origPeriodUnit'
									}, {
										xtype : 'gridcolumn',
										text : '原期限长度',
										dataIndex : 'origPeriodLen'
									}, {
										xtype : 'gridcolumn',
										text : '交易性质',
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_BuyBackAssetAcquired_Tol');
		OSS.setExtValue('tPath', 'TBuybackassetacquiredTol');
	},
...
//		window.parent.ContentTablePanelSet('15bf20a4ca474b82846620fd102cdfa4',
//				'买入返售资产-汇总明细', 'rpt/t_buybackassetacquired_dtl.jsp?mainId='
...
//  				.getSelection();
  		...
  		window.location.href='t_buybackassetacquired_dtl.jsp?mainId='+OSS.getExtValue('hidMainId')+ '&'+OSS.paraName+'='+OSS.userId;
  	},   
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTBuybackassetacquiredTol_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var logInfoListStore = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTBuybackassetacquiredDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTBuybackassetacquiredTol_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTBuybackassetacquiredTolList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TBuybackassetacquiredTolList();
};
