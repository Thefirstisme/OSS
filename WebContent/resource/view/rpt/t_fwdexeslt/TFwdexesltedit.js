...
function getTFwdexesltInfo() {
	...
	if (keyid != "0") {
		...
		myMask.show();
		Ext.Ajax.request({
					url : OSS.getAppName + '/rpt/rptTFwdexeslt_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
					success : function(result) {
						...
						OSS.setExtValue('txnType', d.txnType);
						...
						OSS.setExtValue('delivDt1', d.delivDt1);
						OSS.setExtValue('delivDt2', d.delivDt2);
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
					url : OSS.getAppName + "/rpt/rptTFwdexeslt_" + actionId,
					method : 'post',
					params : params,
