Ext.define('OSS.view.TFwdexesltList', {
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_FwdExeSlt');
		OSS.setExtValue('tPath', 'TFwdexeslt');
	}
	 //修改内容 2014.03.09 HSL 
	,
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName + '/rpt/rptTFwdexeslt_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTFwdexeslt_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTFwdexesltList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TFwdexesltList();
};
