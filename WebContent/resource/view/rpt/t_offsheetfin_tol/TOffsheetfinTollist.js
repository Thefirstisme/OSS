Ext.define('OSS.view.TOffsheetfinTolList', {
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_OffsheetFin_Tol');
		OSS.setExtValue('tPath', 'TOffsheetfinTol');
	},
...
////		window.parent.ContentTablePanelSet('b68dcd656e8b441dadee5d41fb8bf3d7',
////				'表外理财-汇总明细', 'rpt/t_offsheetfin_dtl.jsp?mainId='
////						+ OSS.getExtValue('hidMainId'));
//		window.location.href='t_offsheetfin_dtl.jsp?mainId='+OSS.getExtValue('hidMainId');
//	},
// 
	//修改内容 2014.03.09 HSL 
...
//  				.getSelection();
  		...
  		window.location.href='t_offsheetfin_dtl.jsp?mainId='+OSS.getExtValue('hidMainId')+ '&'+OSS.paraName+'='+OSS.userId;
  	},   
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName + '/rpt/rptTOffsheetfinTol_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var logInfoListStore = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName + '/rpt/rptTOffsheetfinDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTOffsheetfinTol_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTOffsheetfinTolList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TOffsheetfinTolList();
};
