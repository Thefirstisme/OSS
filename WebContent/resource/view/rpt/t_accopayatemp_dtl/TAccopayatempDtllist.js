Ext.define('OSS.view.TAccopayatempDtlList', {
...
//          toCheckDtlClick("T_AccoPayaTemp_Dtl",OSS.getUrlParam('mainId'), 'TAccopayatempDtl');
//    }
});
...
storeMain.on('beforeload', function (store, options) {alert(OSS.getAppName);
	var tempMainId =  OSS.getUrlParam('mainId');
	if('undefined'!=typeof(tempMainId)){
...
var delData=function(id){
	...
	myMask.show();
	Ext.Ajax.request({ 
		url: OSS.getAppName+"/rpt/rptTAccopayatempDtl_toDel",
		method : 'post', 
		params : {id: id},
...
var InitTAccopayatempDtlList=function(){
	Ext.tip.QuickTipManager.init();
	new OSS.view.TAccopayatempDtlList();
};
