Ext.define('OSS.view.TTotaloanDtlList', {
...
//		toCheckDtlClick("T_TotaLoan_Dtl", OSS.getUrlParam('mainId'),
//				'TTotaloanDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTTotaloanDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTTotaloanDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TTotaloanDtlList();
};
