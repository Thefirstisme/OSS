Ext.define('OSS.view.TCentbankreserveDtlList', {
...
//          toCheckDtlClick("T_CentBankReserve_Dtl",OSS.getUrlParam('mainId'), 'TCentbankreserveDtl');
//    }
});
...
var storeMain = Ext.create('Ext.data.JsonStore', {
    ...
    proxy:new Ext.data.HttpProxy({
		url:OSS.getAppName+'/rpt/rptTCentbankreserveDtl_toList',
    	reader:{
    		type:'json',
    		root:'data',
    		totalProperty: 'total'
...
var delData=function(id){
	...
	myMask.show();
	Ext.Ajax.request({ 
		url: OSS.getAppName+"/rpt/rptTCentbankreserveDtl_toDel",
		method : 'post', 
		params : {id: id},
...
var InitTCentbankreserveDtlList=function(){
	Ext.tip.QuickTipManager.init();
	new OSS.view.TCentbankreserveDtlList();
};
