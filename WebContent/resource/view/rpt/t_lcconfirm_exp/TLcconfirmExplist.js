Ext.define('OSS.view.TLcconfirmExpList', {
		...
		Ext.applyIf(me, {
			items : [{
				...
				columns : [{
							...
							xtype : 'gridcolumn',
							text : '受益人企业名称',
							dataIndex : 'benefCorpNm'
						}, {
							xtype : 'gridcolumn',
							text : '受益人企业机构代码',
							dataIndex : 'benefCorpOrgId'
						}, {
							xtype : 'gridcolumn',
							text: '受益人国别代码',
							renderer: getCountryCdRender,
							dataIndex : 'benefCountryCd'
						}, {
							xtype : 'gridcolumn',
							text : '受益人国内地区代码',
							renderer: getDomechargeAreaCdRender,
							dataIndex : 'benefDomeAreaCd'
						}, {
							xtype : 'gridcolumn',
							text : '保兑到期日',
							dataIndex : 'confirmMatureDt',
                            format:'Y-m-d',
                            renderer : stringToDate
						}, {
							xtype : 'gridcolumn',
...
//									}, 
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_LCConfirm_Exp');
		OSS.setExtValue('tPath', 'TLcconfirmExp');
	}
	 //修改内容 2014.03.09 HSL 
	,
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName + '/rpt/rptTLcconfirmExp_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTLcconfirmExp_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTLcconfirmExpList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TLcconfirmExpList();
};
