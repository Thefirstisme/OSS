		...
		Ext.applyIf(me, {
					items : [{
								...
								items : [{
											...
											maxLength : 64,
											fieldLabel : '受益人企业名称',
											blankText : '您未输入受益人企业名称',
											emptyText : '请输入受益人企业名称',
											allowBlank : false
											// regex: /^[a-zA-Z0-9]+$/,
										// regexText: '只能输入字母和数字'
									}	, {
											...
											width : 360,
											maxLength : 20,
											fieldLabel : '受益人企业机构代码',
											blankText : '您未输入受益人企业机构代码',
											emptyText : '请输入受益人企业机构代码',
											allowBlank : false,
											regex : /^[a-zA-Z0-9-]+$/,
											...
											width : 360,
											fieldLabel : '受益人国别代码',
											blankText : '您未输入受益人国别代码',
											emptyText : '请输入受益人国别代码',
											allowBlank : false,
											editable : true,
											queryMode : 'local',
											typeAhead : true,
											...
											confirmTo : 'countryCd',
											vtype : 'custBenefDomeAreaCd',
											vtypeText : '您未输入受益人国内地区代码',
											valueField : 'id'
										}, {
											xtype : 'combobox',
											id : 'benefDomeAreaCd',
											name : 'benefDomeAreaCd',
											width : 360,
											fieldLabel : '受益人国内地区代码',
											blankText : '您未输入受益人国内地区代码',
											emptyText : '请输入受益人国内地区代码',
											editable : true,
											queryMode : 'local',
											typeAhead : true,
											value : '310000',
...
function getTLcconfirmExpInfo() {
	...
	if (keyid != "0") {
		...
		myMask.show();
		Ext.Ajax.request({
					url : OSS.getAppName + '/rpt/rptTLcconfirmExp_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
					success : function(result) {
						...
						OSS.setExtValue('benefCorpNm', d.benefCorpNm);
						OSS.setExtValue('benefCorpOrgId', d.benefCorpOrgId);
						OSS.setExtValue('benefCountryCd', d.benefCountryCd);
						OSS.setExtValue('benefDomeAreaCd', d.benefDomeAreaCd);
						OSS.setExtValue('confirmMatureDt', d.confirmMatureDt);
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
					url : OSS.getAppName + "/rpt/rptTLcconfirmExp_" + actionId,
					method : 'post',
					params : params,
