Ext.define('OSS.view.TLcResvList', {
...
//									}, 
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_Lc_Resv');
		OSS.setExtValue('tPath', 'TLcResv');
	}
	 //修改内容 2014.03.09 HSL 
	,
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName + '/rpt/rptTLcResv_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTLcResv_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTLcResvList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TLcResvList();
};
