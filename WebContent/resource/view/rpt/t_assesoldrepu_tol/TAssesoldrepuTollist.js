Ext.define('OSS.view.TAssesoldrepuTolList', {
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_AsseSoldRepu_Tol');
		OSS.setExtValue('tPath', 'TAssesoldrepuTol');
	},
...
////		window.parent.ContentTablePanelSet('4e29cf9605254efdafbf36f1d092bdbf',
////				'卖出回购资产-汇总明细', 'rpt/t_assesoldrepu_dtl.jsp?mainId='
////						+ OSS.getExtValue('hidMainId'));
//		window.location.href='t_assesoldrepu_dtl.jsp?mainId='+OSS.getExtValue('hidMainId');
//	},
...
//  				.getSelection();
  		...
  		window.location.href='t_assesoldrepu_dtl.jsp?mainId='+OSS.getExtValue('hidMainId')+ '&'+OSS.paraName+'='+OSS.userId;
  	},
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTAssesoldrepuTol_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var logInfoListStore = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTAssesoldrepuDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTAssesoldrepuTol_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTAssesoldrepuTolList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TAssesoldrepuTolList();
};
