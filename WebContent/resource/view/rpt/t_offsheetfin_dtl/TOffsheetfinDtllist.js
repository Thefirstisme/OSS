Ext.define('OSS.view.TOffsheetfinDtlList', {
...
//		toCheckDtlClick("T_OffsheetFin_Dtl", OSS.getUrlParam('mainId'),
//				'TOffsheetfinDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTOffsheetfinDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTOffsheetfinDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TOffsheetfinDtlList();
};
