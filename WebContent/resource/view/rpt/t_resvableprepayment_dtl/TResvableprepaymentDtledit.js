...
var initWin;
function getTResvableprepaymentDtlInfo() {
	...
	if (keyid != "0") {
		...
		Ext.Ajax.request({
					url : OSS.getAppName
							+ '/rpt/rptTResvableprepaymentDtl_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
			url : OSS.getAppName + "/rpt/rptTResvableprepaymentDtl_" + actionId,
			method : 'post',
			params : params,
