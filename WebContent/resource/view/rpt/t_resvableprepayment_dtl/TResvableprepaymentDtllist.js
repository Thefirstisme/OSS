Ext.define('OSS.view.TResvableprepaymentDtlList', {
...
//		toCheckDtlClick("T_ResvablePrepayment_Dtl", OSS.getUrlParam('mainId'),
//				'TResvableprepaymentDtl');
//	}
});
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTResvableprepaymentDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTResvableprepaymentDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTResvableprepaymentDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TResvableprepaymentDtlList();
};
