Ext.define('OSS.view.TSysfinaflowSourDtlList', {
...
//		toCheckDtlClick("T_SysFinaFlow_Sour_Dtl", OSS.getUrlParam('mainId'),
//				'TSysfinaflowSourDtl');
//	}
});
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTSysfinaflowSourDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTSysfinaflowSourDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTSysfinaflowSourDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TSysfinaflowSourDtlList();
};
