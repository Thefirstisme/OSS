Ext.define('OSS.view.TPayableprepaymentDtlList', {
...
//		toCheckDtlClick("T_PayablePrepayment_Dtl", OSS.getUrlParam('mainId'),
//				'TPayableprepaymentDtl');
//	}
});
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTPayableprepaymentDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTPayableprepaymentDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTPayableprepaymentDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TPayableprepaymentDtlList();
};
