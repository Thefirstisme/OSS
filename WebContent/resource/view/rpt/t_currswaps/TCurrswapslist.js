Ext.define('OSS.view.TCurrswapsList', {
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_CurrSwaps');
		OSS.setExtValue('tPath', 'TCurrswaps');
	}
	 //修改内容 2014.03.09 HSL 
	,
...
, {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName + '/rpt/rptTCurrswaps_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTCurrswaps_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTCurrswapsList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TCurrswapsList();
};
