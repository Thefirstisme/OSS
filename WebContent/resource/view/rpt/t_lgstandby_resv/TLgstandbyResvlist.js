Ext.define('OSS.view.TLgstandbyResvList', {
		...
		Ext.applyIf(me, {
			items : [{
				...
				columns : [{
							...
							xtype : 'gridcolumn',
							text : '担保权人名称',
							dataIndex : 'securedPartyNm'
						}, {
							xtype : 'gridcolumn',
							text : '担保权人机构代码',
							dataIndex : 'securedPartyOrgId'
						}, {
							xtype : 'gridcolumn',
							text: '担保权人国别代码',
							renderer: getCountryCdRender,
							dataIndex : 'securedPartyCountryCd'
						}, {
							xtype : 'gridcolumn',
							text : '担保权人国内地区代码',
							renderer: getDomechargeAreaCdRender,
							dataIndex : 'securedPartyDomeAreaCd'
						}, {
							xtype : 'gridcolumn',
							text : '保函到期日',
...
//									},
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_LgStandBy_Resv');
		OSS.setExtValue('tPath', 'TLgstandbyResv');
	}
	 //修改内容 2014.03.09 HSL 
	,
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName + '/rpt/rptTLgstandbyResv_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTLgstandbyResv_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTLgstandbyResvList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TLgstandbyResvList();
};
