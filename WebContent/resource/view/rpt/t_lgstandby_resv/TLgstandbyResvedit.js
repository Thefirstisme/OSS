					...
					items : [{
								...
								items : [{
										...
										// regexText: '只能输入字母和数字'
											...
											xtype : 'textfield',
											id : 'securedPartyOrgId',
											name : 'securedPartyOrgId',
											width : 360,
											maxLength : 20,
											fieldLabel : '担保权人机构代码',
											blankText : '您未输入担保权人机构代码',
											emptyText : '请输入担保权人机构代码',
											allowBlank : false,
											regex : /^[a-zA-Z0-9-]+$/,
											regexText : '只能输入字母或数字或-'
										}, {
											xtype : 'combobox',
											id : 'securedPartyCountryCd',
											name : 'securedPartyCountryCd',
											width : 360,
											fieldLabel : '担保权人国别代码',
											blankText : '您未输入担保权人国别代码',
											emptyText : '请输入担保权人国别代码',
											allowBlank : false,
											editable : true,
											queryMode : 'local',
											typeAhead : true,
											...
											confirmTo : 'countryCd',
											vtype : 'custSecuredPartyDomeAreaCd',
											vtypeText : '您未输入担保权人国内地区代码',
											valueField : 'id'
										}, {
											xtype : 'combobox',
											id : 'securedPartyDomeAreaCd',
											name : 'securedPartyDomeAreaCd',
											width : 360,
											fieldLabel : '担保权人国内地区代码',
											blankText : '您未输入担保权人国内地区代码',
											emptyText : '请输入担保权人国内地区代码',
											editable : true,
											queryMode : 'local',
											typeAhead : true,
											value : '310000',
...
var initWin;
function getTLgstandbyResvInfo() {
	...
	if (keyid != "0") {
		...
		myMask.show();
		Ext.Ajax.request({
					url : OSS.getAppName + '/rpt/rptTLgstandbyResv_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
					success : function(result) {
						...
						OSS.setExtValue('securedPartyNm', d.securedPartyNm);
						OSS.setExtValue('securedPartyOrgId',
								d.securedPartyOrgId);
						OSS.setExtValue('securedPartyCountryCd',
								d.securedPartyCountryCd);
						OSS.setExtValue('securedPartyDomeAreaCd',
								d.securedPartyDomeAreaCd);
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
					url : OSS.getAppName + "/rpt/rptTLgstandbyResv_" + actionId,
					method : 'post',
					params : params,
