...
var initWin;
function getTBankaccepbillPayInfo() {
	...
	if (keyid != "0") {
		...
		myMask.show();
		Ext.Ajax.request({
					url : OSS.getAppName + '/rpt/rptTBankaccepbillPay_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
					success : function(result) {
						...
						OSS.setExtValue('acptDt', d.acptDt);
						OSS.setExtValue('acptMatureDt', d.acptMatureDt);
						OSS.setExtValue('acptAmt', d.acptAmt);
						OSS.setExtValue('currencyCd', d.currencyCd);
						OSS.setExtValue('corpAcctId', d.corpAcctId);
						OSS.setExtValue('corpNm', d.corpNm);
						OSS.setExtValue('corpId', d.corpId);
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
					url : OSS.getAppName + "/rpt/rptTBankaccepbillPay_"
							+ actionId,
					method : 'post',
					params : params,
