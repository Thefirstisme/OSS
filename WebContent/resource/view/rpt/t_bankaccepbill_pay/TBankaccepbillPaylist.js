Ext.define('OSS.view.TBankaccepbillPayList', {
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_BankAccepBill_Pay');
		OSS.setExtValue('tPath', 'TBankaccepbillPay');
	}
    //修改内容 2014.03.09 HSL 
	,
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTBankaccepbillPay_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTBankaccepbillPay_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTBankaccepbillPayList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TBankaccepbillPayList();
};
