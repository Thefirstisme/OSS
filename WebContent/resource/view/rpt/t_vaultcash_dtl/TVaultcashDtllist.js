Ext.define('OSS.view.TVaultcashDtlList', {
...
//		toCheckDtlClick("T_VaultCash_Dtl", OSS.getUrlParam('mainId'),
//				'TVaultcashDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTVaultcashDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTVaultcashDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TVaultcashDtlList();
};
