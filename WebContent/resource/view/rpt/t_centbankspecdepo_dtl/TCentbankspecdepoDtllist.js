Ext.define('OSS.view.TCentbankspecdepoDtlList', {
...
//		toCheckDtlClick("T_CentBankSpecDepo_Dtl", OSS.getUrlParam('mainId'),
//				'TCentbankspecdepoDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTCentbankspecdepoDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTCentbankspecdepoDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TCentbankspecdepoDtlList();
};
