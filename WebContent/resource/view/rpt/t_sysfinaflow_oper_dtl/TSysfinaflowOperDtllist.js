Ext.define('OSS.view.TSysfinaflowOperDtlList', {
...
//		toCheckDtlClick("T_SysFinaFlow_Oper_Dtl", OSS.getUrlParam('mainId'),
//				'TSysfinaflowOperDtl');
//	}
});
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTSysfinaflowOperDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTSysfinaflowOperDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTSysfinaflowOperDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TSysfinaflowOperDtlList();
};
