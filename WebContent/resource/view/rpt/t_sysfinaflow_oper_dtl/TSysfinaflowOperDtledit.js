...
var initWin;
function getTSysfinaflowOperDtlInfo() {
	...
	if (keyid != "0") {
		...
		myMask.show();
		Ext.Ajax.request({
					url : OSS.getAppName + '/rpt/rptTSysfinaflowOperDtl_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
					url : OSS.getAppName + "/rpt/rptTSysfinaflowOperDtl_"
							+ actionId,
					method : 'post',
					params : params,
