Ext.define('OSS.view.TEquityotherinvestDtlList', {
...
//		toCheckDtlClick("T_EquityOtherInvest_Dtl", OSS.getUrlParam('mainId'),
//				'TEquityotherinvestDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTEquityotherinvestDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTEquityotherinvestDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TEquityotherinvestDtlList();
};
