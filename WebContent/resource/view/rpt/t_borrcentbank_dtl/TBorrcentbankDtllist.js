Ext.define('OSS.view.TBorrcentbankDtlList', {
...
//          toCheckDtlClick("T_BorrCentBank_Dtl",OSS.getUrlParam('mainId'), 'TBorrcentbankDtl');
//    }
});
...
var storeMain = Ext.create('Ext.data.JsonStore', {
    ...
    proxy:new Ext.data.HttpProxy({
		url:OSS.getAppName+'/rpt/rptTBorrcentbankDtl_toList',
    	reader:{
    		type:'json',
    		root:'data',
    		totalProperty: 'total'
...
var delData=function(id){
	...
	myMask.show();
	Ext.Ajax.request({ 
		url: OSS.getAppName+"/rpt/rptTBorrcentbankDtl_toDel",
		method : 'post', 
		params : {id: id},
...
var InitTBorrcentbankDtlList=function(){
	Ext.tip.QuickTipManager.init();
	new OSS.view.TBorrcentbankDtlList();
};
