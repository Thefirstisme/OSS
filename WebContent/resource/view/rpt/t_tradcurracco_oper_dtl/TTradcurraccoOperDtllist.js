Ext.define('OSS.view.TTradcurraccoOperDtlList', {
...
//		toCheckDtlClick("T_TradCurrAcco_Oper_Dtl", OSS.getUrlParam('mainId'),
//				'TTradcurraccoOperDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTTradcurraccoOperDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTTradcurraccoOperDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TTradcurraccoOperDtlList();
};
