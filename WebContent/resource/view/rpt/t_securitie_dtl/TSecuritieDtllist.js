Ext.define('OSS.view.TSecuritieDtlList', {
...
//		toCheckDtlClick("T_Securitie_Dtl", OSS.getUrlParam('mainId'),
//				'TSecuritieDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTSecuritieDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTSecuritieDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TSecuritieDtlList();
};
