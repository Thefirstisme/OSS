Ext.define('OSS.view.TFtuFinabondDtlList', {
...
//		toCheckDtlClick("T_FTU_FinaBond_Dtl", OSS.getUrlParam('mainId'),
//				'TFtuFinabondDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTFtuFinabondDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTFtuFinabondDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TFtuFinabondDtlList();
};
