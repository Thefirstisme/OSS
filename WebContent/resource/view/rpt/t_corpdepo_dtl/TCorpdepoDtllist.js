Ext.define('OSS.view.TCorpdepoDtlList', {
...
//      	toCheckDtlClick("T_CorpDepo_Dtl", OSS.getUrlParam('mainId'),'TCorpdepoDtl');
//    }
});
...
function editRowData(id,editType){
	...
	OSS.setExtValue('fixDepoInd',OSS.getUrlParam('fixDepoInd'));
...
var delData=function(id){
	...
	myMask.show();
	Ext.Ajax.request({ 
		url: OSS.getAppName+"/rpt/rptTCorpdepoDtl_toDel",
		method : 'post', 
		params : {id: id},
...
var InitTCorpdepoDtlList=function(){
	Ext.tip.QuickTipManager.init();
	new OSS.view.TCorpdepoDtlList();
};
