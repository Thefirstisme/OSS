Ext.define('OSS.view.TForextradespotSourDtlList', {
...
//		toCheckDtlClick("T_FOREXTradeSpot_Sour_Dtl", OSS.getUrlParam('mainId'),
//				'TForextradespotSourDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTForextradespotSourDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTForextradespotSourDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TForextradespotSourDtlList();
};
