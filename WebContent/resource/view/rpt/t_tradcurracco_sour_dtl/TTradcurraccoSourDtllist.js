Ext.define('OSS.view.TTradcurraccoSourDtlList', {
...
//		toCheckDtlClick("T_TradCurrAcco_Sour_Dtl", OSS.getUrlParam('mainId'),
//				'TTradcurraccoSourDtl');
//	}
});
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTTradcurraccoSourDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTTradcurraccoSourDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTTradcurraccoSourDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TTradcurraccoSourDtlList();
};
