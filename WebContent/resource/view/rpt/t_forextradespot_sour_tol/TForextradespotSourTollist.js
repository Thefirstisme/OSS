Ext.define('OSS.view.TForextradespotSourTolList', {
			...
			items : [{
				...
				items : [{
							...
							columns : [{
										...
										xtype : 'gridcolumn',
										text: '外汇买卖类型',
										renderer: getFxTradeTypeRender,
										dataIndex : 'fxTradeType'
									}, {
										xtype : 'gridcolumn',
										text: '买入币种',
										renderer: getCurrencyCdRender,
...
//										dataIndex : 'deliverydate'
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_FOREXTradeSpot_Sour_Tol');
		OSS.setExtValue('tPath', 'TForextradespotSourTol');
	},
...
//		window.parent.ContentTablePanelSet('44d5f9329e2441f0b16f834ac803103e',
//				'外汇买卖（即期）-汇总明细', 'rpt/t_forextradespot_sour_dtl.jsp?mainId='
...
//  				.getSelection();
  		...
  		window.location.href='t_forextradespot_sour_dtl.jsp?mainId='+OSS.getExtValue('hidMainId')+ '&'+OSS.paraName+'='+OSS.userId;
  	},   
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTForextradespotSourTol_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
//						type : 'string'
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTForextradespotSourDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTForextradespotSourTol_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTForextradespotSourTolList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TForextradespotSourTolList();
};
