...
var initWin;
function getTFtuEntrdsavTolInfo() {
	...
	if (keyid != "0") {
		...
		myMask.show();
		Ext.Ajax.request({
					url : OSS.getAppName + '/rpt/rptTFtuEntrdsavTol_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
					url : OSS.getAppName + "/rpt/rptTFtuEntrdsavTol_"
							+ actionId,
					method : 'post',
					params : params,
