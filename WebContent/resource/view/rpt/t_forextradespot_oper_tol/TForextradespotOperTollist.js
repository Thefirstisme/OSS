Ext.define('OSS.view.TForextradespotOperTolList', {
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_FOREXTradeSpot_Oper_Tol');
		OSS.setExtValue('tPath', 'TForextradespotOperTol');
	},
...
//		window.parent.ContentTablePanelSet('2a61b3f767274f3aa9f0c8271b47ea4c',
//				'外汇买卖-汇总明细', 'rpt/t_forextradespot_oper_dtl.jsp?mainId='
...
//  				.getSelection();
  		...
  		window.location.href='t_forextradespot_oper_dtl.jsp?mainId='+OSS.getExtValue('hidMainId')+ '&'+OSS.paraName+'='+OSS.userId;
  	},   
...
, {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTForextradespotOperTol_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
, {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTForextradespotOperDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTForextradespotOperTol_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTForextradespotOperTolList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TForextradespotOperTolList();
};
