Ext.define('OSS.view.TSysfinaflowDtlList', {
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName + '/rpt/rptTSysfinaflowDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTSysfinaflowDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTSysfinaflowDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TSysfinaflowDtlList();
};
