Ext.define('OSS.view.TForextradespotOperDtlList', {
...
//		toCheckDtlClick("T_FOREXTradeSpot_Oper_Dtl", OSS.getUrlParam('mainId'),
//				'TForextradespotOperDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTForextradespotOperDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTForextradespotOperDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TForextradespotOperDtlList();
};
