Ext.define('OSS.view.TBankaccepbillResvList', {
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_BankAccepBill_Resv');
		OSS.setExtValue('tPath', 'TBankaccepbillResv');
	}	
	//修改内容 2014.03.09 HSL 
	,
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTBankaccepbillResv_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTBankaccepbillResv_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTBankaccepbillResvList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TBankaccepbillResvList();
};
