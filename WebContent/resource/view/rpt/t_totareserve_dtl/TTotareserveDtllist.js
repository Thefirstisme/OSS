Ext.define('OSS.view.TTotareserveDtlList', {
...
//		toCheckDtlClick("T_TotaReserve_Dtl", OSS.getUrlParam('mainId'),
//				'TTotareserveDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTTotareserveDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTTotareserveDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TTotareserveDtlList();
};
