Ext.define('OSS.view.TLcconfirmImpList', {
		...
		Ext.applyIf(me, {
			items : [{
				...
				columns : [{
							...
							xtype : 'gridcolumn',
							text : '申请人企业名称',
							dataIndex : 'applicantCorpNm'
						}, {
							xtype : 'gridcolumn',
							text : '申请人企业机构代码',
							dataIndex : 'applicantCorpOrgId'
						}, {
							xtype : 'gridcolumn',
							text: '申请人国别代码',
...
//									}, 
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_LCConfirm_Imp');
		OSS.setExtValue('tPath', 'TLcconfirmImp');
	}
	 //修改内容 2014.03.09 HSL 
	,
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName + '/rpt/rptTLcconfirmImp_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTLcconfirmImp_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTLcconfirmImpList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TLcconfirmImpList();
};
