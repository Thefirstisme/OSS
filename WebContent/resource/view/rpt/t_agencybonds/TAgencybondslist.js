		...
		.define(
				'OSS.view.TAgencybondsList',
				{
											...
											items : [ {
												...
												columns : [
														...
														},
														{
															xtype : 'gridcolumn',
															text : '发债企业账号',
															dataIndex : 'issuCorpAcct'
														},
														{
															xtype : 'gridcolumn',
															text : '货币',
															renderer : getCurrencyCdRender1,
														...
														},
														{
															xtype : 'gridcolumn',
															text : '定价基准',
															renderer : getPriceDatumRender,
															dataIndex : 'priceDatum'
														},
														{
															xtype : 'gridcolumn',
															text : '浮动点差',
															dataIndex : 'floatSpread'
														} , {
															xtype : 'gridcolumn',
															text : '创建人',
					...
					onShbRHClick : function(item, e, eOpts) {
						...
						OSS.setExtValue('tableName', 'T_AgencyBonds');
						OSS.setExtValue('tPath', 'TAgencybonds');
					}
					// 修改内容 2014.03.09 HSL
					,
...
var storeMain = Ext.create('Ext.data.JsonStore', {
	...
	proxy : new Ext.data.HttpProxy({
		url : OSS.getAppName + '/rpt/rptTAgencybonds_toList',
		reader : {
			type : 'json',
			root : 'data',
			totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
		url : OSS.getAppName + "/rpt/rptTAgencybonds_toDel",
		method : 'post',
		params : {
			id : id
		},
...
var InitTAgencybondsList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TAgencybondsList();
};
