Ext.define('OSS.view.TAgententrdloanfundTolList', {
...
//	window.parent.ContentTablePanelSet('42aabd6cb6664b9b87ae00a409524676',
//			'代理金融机构委托贷款基金-汇总明细', 'rpt/t_agententrdloanfund_dtl.jsp?mainId='
...
//				.getSelection();
		...
		window.location.href='t_agententrdloanfund_dtl.jsp?mainId='+OSS.getExtValue('hidMainId')+ '&'+OSS.paraName+'='+OSS.userId;
	}, 
	...
	onShbRHClick : function(item, e, eOpts) {
		...
		OSS.setExtValue('tableName', 'T_AgentEntrdLoanFund_Tol');
		OSS.setExtValue('tPath', 'TAgententrdloanfundTol');
	},
...
var storeMain = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTAgententrdloanfundTol_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var logInfoListStore = Ext.create('Ext.data.JsonStore', {
			...
			proxy : new Ext.data.HttpProxy({
						url : OSS.getAppName
								+ '/rpt/rptTAgententrdloanfundDtl_toList',
						reader : {
							type : 'json',
							root : 'data',
							totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTAgententrdloanfundTol_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTAgententrdloanfundTolList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TAgententrdloanfundTolList();
};
