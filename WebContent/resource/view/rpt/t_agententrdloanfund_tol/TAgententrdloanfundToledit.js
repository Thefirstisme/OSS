...
var initWin;
function getTAgententrdloanfundTolInfo() {
	...
	if (keyid != "0") {
		...
		Ext.Ajax.request({
					url : OSS.getAppName
							+ '/rpt/rptTAgententrdloanfundTol_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
			url : OSS.getAppName + "/rpt/rptTAgententrdloanfundTol_" + actionId,
			method : 'post',
			params : params,
