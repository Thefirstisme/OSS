Ext.define(
				'OSS.view.TPayableprepaymentTolList',
				{
					...
					onShbRHClick : function(item, e, eOpts) {
						...
						OSS.setExtValue('tableName', 'T_PayablePrepayment_Tol');
						OSS.setExtValue('tPath', 'TPayableprepaymentTol');
					},
					...
					// window.parent.ContentTablePanelSet('beaf02ddef8644ef8de0731ed8f47761',
					// '应收及预付款-汇总明细', 'rpt/t_payableprepayment_dtl.jsp?mainId='
					...
					infoListMore : function(item, e, eOpts) {
						...
						window.location.href = 't_payableprepayment_dtl.jsp?mainId='
...
var storeMain = Ext.create('Ext.data.JsonStore', {
	...
	proxy : new Ext.data.HttpProxy({
		url : OSS.getAppName + '/rpt/rptTPayableprepaymentTol_toList',
		reader : {
			type : 'json',
			root : 'data',
			totalProperty : 'total'
...
var logInfoListStore = Ext.create('Ext.data.JsonStore', {
	...
	proxy : new Ext.data.HttpProxy({
		url : OSS.getAppName + '/rpt/rptTPayableprepaymentDtl_toList',
		reader : {
			type : 'json',
			root : 'data',
			totalProperty : 'total'
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
		url : OSS.getAppName + "/rpt/rptTPayableprepaymentTol_toDel",
		method : 'post',
		params : {
			id : id
		},
...
var InitTPayableprepaymentTolList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TPayableprepaymentTolList();
};
