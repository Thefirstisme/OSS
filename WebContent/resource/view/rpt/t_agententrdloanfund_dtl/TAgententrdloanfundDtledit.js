...
var initWin;
function getTAgententrdloanfundDtlInfo() {
	...
	if (keyid != "0") {
		...
		Ext.Ajax.request({
					url : OSS.getAppName
							+ '/rpt/rptTAgententrdloanfundDtl_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
			url : OSS.getAppName + "/rpt/rptTAgententrdloanfundDtl_" + actionId,
			method : 'post',
			params : params,
