Ext.define('OSS.view.TAgententrdloanfundDtlList', {
...
//          toCheckDtlClick("T_AgentEntrdLoanFund_Dtl",OSS.getUrlParam('mainId'), 'TAgententrdloanfundDtl');
//    }
});
...
//	    {name: 'currencyCd',type:'string'},
    ...
    proxy:new Ext.data.HttpProxy({
		url:OSS.getAppName+'/rpt/rptTAgententrdloanfundDtl_toList',
    	reader:{
    		type:'json',
    		root:'data',
    		totalProperty: 'total'
...
var delData=function(id){
	...
	myMask.show();
	Ext.Ajax.request({ 
		url: OSS.getAppName+"/rpt/rptTAgententrdloanfundDtl_toDel",
		method : 'post', 
		params : {id: id},
...
var InitTAgententrdloanfundDtlList=function(){
	Ext.tip.QuickTipManager.init();
	new OSS.view.TAgententrdloanfundDtlList();
};
