...
var initWin;
function getTCentbankfinsavdepoDtlInfo() {
	...
	if (keyid != "0") {
		...
		Ext.Ajax.request({
					url : OSS.getAppName
							+ '/rpt/rptTCentbankfinsavdepoDtl_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
			url : OSS.getAppName + "/rpt/rptTCentbankfinsavdepoDtl_" + actionId,
			method : 'post',
			params : params,
