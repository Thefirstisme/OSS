Ext.define('OSS.view.TCentbankfinsavdepoDtlList', {
...
//		toCheckDtlClick("T_CentBankFinSavDepo_Dtl", OSS.getUrlParam('mainId'),
//				'TCentbankfinsavdepoDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTCentbankfinsavdepoDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTCentbankfinsavdepoDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TCentbankfinsavdepoDtlList();
};
