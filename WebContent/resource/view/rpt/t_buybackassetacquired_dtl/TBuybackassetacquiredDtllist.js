Ext.define('OSS.view.TBuybackassetacquiredDtlList', {
...
//		toCheckDtlClick("T_BuyBackAssetAcquired_Dtl",
//				OSS.getUrlParam('mainId'), 'TBuybackassetacquiredDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTBuybackassetacquiredDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTBuybackassetacquiredDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TBuybackassetacquiredDtlList();
};
