Ext.define('OSS.view.RowDataEdit', {
					...
					items : [{
								...
								items : [{
										...
										// },
										{
											...
											confirmTo : 'origTxnDt',
											vtype : 'custOutInAcctIndRegexAll',
											...
											listeners:{  
											    'change':function(){    
											    	setMatureDt('intStartDt', 'origPeriodLen','origPeriodUnit','matureDt');    
											    }
											}
										}, {
											xtype : 'combobox',
											...
											xtype : 'combobox',
											id : 'oppositeCustAttri',
											name : 'oppositeCustAttri',
											width : 360,
											fieldLabel : '对方客户性质',
											blankText : '您未输入对方客户性质',
											emptyText : '请输入对方客户性质',
											allowBlank : false,
											editable : false,
											queryMode : 'local',
											...
											value : '-1',
											displayField : 'name',
											store : storeSaleAssetType,
											valueField : 'id'
										}, {
											xtype : 'textfield',
											id : 'origAssetTotalVal',
											name : 'origAssetTotalVal',
											width : 360,
											fieldLabel : '原资产总价值',
											blankText : '您未输入原资产总价值',
											emptyText : '请输入原资产总价值',
											allowBlank : false,
											maxLength : 24,
											decimalPrecision : 2,
	...
	onWindowShow : function(component, eOpts) {
		initWin = this;
		setTimeout(function() {
					getTBuybackassetacquiredDtlInfo();
				}, 100);
	},
...
var initWin;
function getTBuybackassetacquiredDtlInfo() {
	...
	if (keyid != "0") {
		...
		Ext.Ajax.request({
					url : OSS.getAppName
							+ '/rpt/rptTBuybackassetacquiredDtl_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
					success : function(result) {
						...
						OSS.setExtValue('oppositeCustAttri',
								d.oppositeCustAttri);
						...
						OSS.setExtValue('buyAssetType', d.buyAssetType);
						OSS.setExtValue('origAssetTotalVal',
								d.origAssetTotalVal);
						OSS.setExtValue('origPeriodUnit', d.origPeriodUnit);
						OSS.setExtValue('origPeriodLen', d.origPeriodLen);
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
					url : OSS.getAppName + "/rpt/rptTBuybackassetacquiredDtl_"
							+ actionId,
					method : 'post',
					params : params,
