...
var initWin;
function getTResvableprepaymentTolInfo() {
	...
	if (keyid != "0") {
		...
		Ext.Ajax.request({
					url : OSS.getAppName
							+ '/rpt/rptTResvableprepaymentTol_toEnt',
					method : 'post',
					params : {
						id : keyid
					},
...
var toUpdate = function() {
	...
	if (formpPanel1.form.isValid()) {
		...
		Ext.Ajax.request({
			url : OSS.getAppName + "/rpt/rptTResvableprepaymentTol_" + actionId,
			method : 'post',
			params : params,
