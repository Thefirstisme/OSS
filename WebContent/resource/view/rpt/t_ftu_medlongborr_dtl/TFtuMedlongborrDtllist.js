Ext.define('OSS.view.TFtuMedlongborrDtlList', {
...
//		toCheckDtlClick("T_FTU_MedLongBorr_Dtl", OSS.getUrlParam('mainId'),
//				'TFtuMedlongborrDtl');
//	}
});
...
var delData = function(id) {
	...
	myMask.show();
	Ext.Ajax.request({
				url : OSS.getAppName + "/rpt/rptTFtuMedlongborrDtl_toDel",
				method : 'post',
				params : {
					id : id
				},
...
var InitTFtuMedlongborrDtlList = function() {
	Ext.tip.QuickTipManager.init();
	new OSS.view.TFtuMedlongborrDtlList();
};
