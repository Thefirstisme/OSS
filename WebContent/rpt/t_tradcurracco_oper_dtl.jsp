...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_tradcurracco_oper_dtl/TTradcurraccoOperDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_tradcurracco_oper_dtl/TTradcurraccoOperDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTTradcurraccoOperDtlList);
</script>
</body>
</html>
