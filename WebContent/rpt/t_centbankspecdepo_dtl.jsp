...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_centbankspecdepo_dtl/TCentbankspecdepoDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_centbankspecdepo_dtl/TCentbankspecdepoDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTCentbankspecdepoDtlList);
</script>
</body>
</html>
