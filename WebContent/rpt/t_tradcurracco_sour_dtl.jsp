...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_tradcurracco_sour_dtl/TTradcurraccoSourDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_tradcurracco_sour_dtl/TTradcurraccoSourDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTTradcurraccoSourDtlList);
</script>
</body>
</html>
