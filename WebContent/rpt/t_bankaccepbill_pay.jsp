...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_bankaccepbill_pay/TBankaccepbillPaylist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_bankaccepbill_pay/TBankaccepbillPayedit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTBankaccepbillPayList);
</script>
</body>
</html>
