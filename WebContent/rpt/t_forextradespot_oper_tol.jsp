...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_forextradespot_oper_tol/TForextradespotOperTollist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_forextradespot_oper_tol/TForextradespotOperToledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTForextradespotOperTolList);
</script>
</body>
</html>
