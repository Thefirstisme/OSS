...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_payableprepayment_dtl/TPayableprepaymentDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_payableprepayment_dtl/TPayableprepaymentDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTPayableprepaymentDtlList);
</script>
</body>
</html>
