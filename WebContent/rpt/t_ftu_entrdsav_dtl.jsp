...
<title>FTU委托存款及委托投资基金（净）-明细</title>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_ftu_entrdsav_dtl/TFtuEntrdsavDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_ftu_entrdsav_dtl/TFtuEntrdsavDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTFtuEntrdsavDtlList);
</script>
</body>
</html>
