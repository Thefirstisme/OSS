...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_borrcentbank_dtl/TBorrcentbankDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_borrcentbank_dtl/TBorrcentbankDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTBorrcentbankDtlList);
</script>
</body>
</html>
