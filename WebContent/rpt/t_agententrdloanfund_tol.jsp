...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_agententrdloanfund_tol/TAgententrdloanfundTollist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_agententrdloanfund_tol/TAgententrdloanfundToledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTAgententrdloanfundTolList);
</script>
</body>
</html>
