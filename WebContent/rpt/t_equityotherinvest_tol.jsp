...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_equityotherinvest_tol/TEquityotherinvestTollist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_equityotherinvest_tol/TEquityotherinvestToledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTEquityotherinvestTolList);
</script>
</body>
</html>
