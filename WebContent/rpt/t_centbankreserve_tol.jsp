...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_centbankreserve_tol/TCentbankreserveTollist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_centbankreserve_tol/TCentbankreserveToledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTCentbankreserveTolList);
</script>
</body>
</html>
