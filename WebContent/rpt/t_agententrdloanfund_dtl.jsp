...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_agententrdloanfund_dtl/TAgententrdloanfundDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_agententrdloanfund_dtl/TAgententrdloanfundDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTAgententrdloanfundDtlList);
</script>
</body>
</html>
