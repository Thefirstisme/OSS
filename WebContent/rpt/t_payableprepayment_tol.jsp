...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_payableprepayment_tol/TPayableprepaymentTollist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_payableprepayment_tol/TPayableprepaymentToledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTPayableprepaymentTolList);
</script>
</body>
</html>
