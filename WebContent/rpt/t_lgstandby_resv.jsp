...
<title>应收保函/备用证（保函通知，收到境外保函）</title>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_lgstandby_resv/TLgstandbyResvlist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_lgstandby_resv/TLgstandbyResvedit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTLgstandbyResvList);
</script>
</body>
</html>
