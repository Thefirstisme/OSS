...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_resvableprepayment_dtl/TResvableprepaymentDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_resvableprepayment_dtl/TResvableprepaymentDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTResvableprepaymentDtlList);
</script>
</body>
</html>
