...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_sysfinaflow_oper_dtl/TSysfinaflowOperDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_sysfinaflow_oper_dtl/TSysfinaflowOperDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTSysfinaflowOperDtlList);
</script>
</body>
</html>
