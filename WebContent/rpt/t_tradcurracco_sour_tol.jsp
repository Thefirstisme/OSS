...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_tradcurracco_sour_tol/TTradcurraccoSourTollist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_tradcurracco_sour_tol/TTradcurraccoSourToledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTTradcurraccoSourTolList);
</script>
</body>
</html>
