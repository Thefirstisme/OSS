...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_sysfinaflow_sour_tol/TSysfinaflowSourTollist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_sysfinaflow_sour_tol/TSysfinaflowSourToledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTSysfinaflowSourTolList);
</script>
</body>
</html>
