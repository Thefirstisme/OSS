...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_resvableprepayment_tol/TResvableprepaymentTollist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_resvableprepayment_tol/TResvableprepaymentToledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTResvableprepaymentTolList);
</script>
</body>
</html>
