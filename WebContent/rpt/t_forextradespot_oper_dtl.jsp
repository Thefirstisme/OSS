...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_forextradespot_oper_dtl/TForextradespotOperDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_forextradespot_oper_dtl/TForextradespotOperDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTForextradespotOperDtlList);
</script>
</body>
</html>
