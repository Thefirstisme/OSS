...
<title>FTU委托存款及委托投资基金（净）-汇总</title>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_ftu_entrdsav_tol/TFtuEntrdsavTollist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_ftu_entrdsav_tol/TFtuEntrdsavToledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTFtuEntrdsavTolList);
</script>
</body>
</html>
