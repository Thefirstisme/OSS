...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_buybackassetacquired_tol/TBuybackassetacquiredTollist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_buybackassetacquired_tol/TBuybackassetacquiredToledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTBuybackassetacquiredTolList);
</script>
</body>
</html>
