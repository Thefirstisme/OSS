...
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_ftu_medlongborr_dtl/TFtuMedlongborrDtllist.js?_t=<%=Math.random()%>"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/resource/view/rpt/t_ftu_medlongborr_dtl/TFtuMedlongborrDtledit.js?_t=<%=Math.random()%>"></script>
</head>
<body>
<script type="text/javascript">	
	    Ext.onReady(InitTFtuMedlongborrDtlList);
</script>
</body>
</html>
